...
describe('ShimmerLoader', () => {
  ...
  describe('List Type', () => {
    it('renders list shimmer structure', () => {
      const { container } = render(<ShimmerLoader type="list" count={3} />);
    ...
    it('renders list shimmer with count=1', () => {
      const { container } = render(<ShimmerLoader type="list" count={1} />);
    ...
    it('renders more boxes with higher count', () => {
      const { container: container3 } = render(<ShimmerLoader type="list" count={3} />);
      const { container: container6 } = render(<ShimmerLoader type="list" count={6} />);
  ...
  describe('Table Type', () => {
    it('renders table shimmer structure', () => {
      const { container } = render(<ShimmerLoader type="table" />);
    ...
    it('renders table shimmer with specified count', () => {
      const { container } = render(<ShimmerLoader type="table" count={4} />);
    ...
    it('renders table shimmer with count=1', () => {
      const { container } = render(<ShimmerLoader type="table" count={1} />);
    ...
    it('renders more boxes with higher count for table', () => {
      const { container: container2 } = render(<ShimmerLoader type="table" count={2} />);
      const { container: container5 } = render(<ShimmerLoader type="table" count={5} />);
  ...
  describe('Card Type', () => {
    it('renders card shimmer structure', () => {
      const { container } = render(<ShimmerLoader type="card" />);
    ...
    it('renders card shimmer with specified count', () => {
      const { container } = render(<ShimmerLoader type="card" count={2} />);
    ...
    it('renders card shimmer with count=1', () => {
      const { container } = render(<ShimmerLoader type="card" count={1} />);
    ...
    it('renders more boxes with higher count for card', () => {
      const { container: container2 } = render(<ShimmerLoader type="card" count={2} />);
      const { container: container8 } = render(<ShimmerLoader type="card" count={8} />);
  ...
  describe('Simple List Type', () => {
    it('renders simple-list shimmer structure', () => {
      const { container } = render(<ShimmerLoader type="simple-list" />);
    ...
    it('renders simple-list shimmer with specified count', () => {
      const { container } = render(<ShimmerLoader type="simple-list" count={5} />);
    ...
    it('renders simple-list shimmer with count=1', () => {
      const { container } = render(<ShimmerLoader type="simple-list" count={1} />);
    ...
    it('renders more boxes with higher count for simple-list', () => {
      const { container: container2 } = render(<ShimmerLoader type="simple-list" count={2} />);
      const { container: container6 } = render(<ShimmerLoader type="simple-list" count={6} />);
  ...
  describe('Header Type', () => {
    it('renders header shimmer', () => {
      const { container } = render(<ShimmerLoader type="header" />);
    ...
    it('renders header shimmer regardless of count prop', () => {
      const { container: container1 } = render(<ShimmerLoader type="header" count={1} />);
      const { container: container10 } = render(<ShimmerLoader type="header" count={10} />);
  ...
  describe('Title Type', () => {
    it('renders title shimmer', () => {
      const { container } = render(<ShimmerLoader type="title" />);
    ...
    it('renders title shimmer regardless of count prop', () => {
      const { container: container1 } = render(<ShimmerLoader type="title" count={1} />);
      const { container: container10 } = render(<ShimmerLoader type="title" count={10} />);
  ...
  describe('Count Prop', () => {
    it('renders nothing with count=0 for list', () => {
      const { container } = render(<ShimmerLoader type="list" count={0} />);
    ...
    it('renders nothing with count=0 for table', () => {
      const { container } = render(<ShimmerLoader type="table" count={0} />);
    ...
    it('renders nothing with count=0 for card', () => {
      const { container } = render(<ShimmerLoader type="card" count={0} />);
    ...
    it('renders nothing with count=0 for simple-list', () => {
      const { container } = render(<ShimmerLoader type="simple-list" count={0} />);
    ...
    it('renders correct proportional boxes for different counts', () => {
      const { container: container5 } = render(<ShimmerLoader type="list" count={5} />);
      const { container: container10 } = render(<ShimmerLoader type="list" count={10} />);
  ...
  describe('Default Fallback', () => {
    it('renders list shimmer as default when type is undefined', () => {
      const { container } = render(<ShimmerLoader count={3} />);
    ...
    it('renders same structure for list type and default', () => {
      const { container: containerDefault } = render(<ShimmerLoader count={2} />);
      const { container: containerList } = render(<ShimmerLoader type="list" count={2} />);
  ...
  describe('Container Structure', () => {
    ...
    it('renders container for all shimmer types', () => {
      ...
      types.forEach(type => {
        const { container } = render(<ShimmerLoader type={type} />);
        const rootBox = container.firstChild as HTMLElement;
        expect(rootBox).toBeInTheDocument();
        expect(rootBox).toHaveClass('MuiBox-root');
      });
  ...
  describe('Accessibility', () => {
    ...
    it('all shimmer types have no interactive elements', () => {
      ...
      types.forEach(type => {
        const { container } = render(<ShimmerLoader type={type} count={1} />);
  ...
  describe('Type Switching', () => {
    it('switches from list to table type', () => {
      const { container: listContainer } = render(<ShimmerLoader type="list" count={2} />);
      const { container: tableContainer } = render(<ShimmerLoader type="table" count={2} />);
    ...
    it('switches from card to simple-list type', () => {
      const { container: cardContainer } = render(<ShimmerLoader type="card" count={2} />);
      const { container: simpleListContainer } = render(<ShimmerLoader type="simple-list" count={2} />);
    ...
    it('header and title types are different structures', () => {
      const { container: headerContainer } = render(<ShimmerLoader type="header" />);
      const { container: titleContainer } = render(<ShimmerLoader type="title" />);
